...
import com.azulita.springboot.backend.gestioneducativa.integration.EquisfaxAPI;
...
public class ClienteController {
	...
	private final EquisfaxAPI equisfaxAPI;

    public ClienteController(IAlumnoService alumnoService, EquisfaxAPI equisfaxAPI) {
		this.alumnoService = alumnoService;
		this.equisfaxAPI = equisfaxAPI;
	}
	...
	public ResponseEntity<?> create(@Validated @RequestBody Alumno alumno, BindingResult result) {
		...
		if (result.hasErrors()) 
		{
			...
			ResponseEntity<?> respuesta = equisfaxAPI.send(alumno);
			if(respuesta.getStatusCode()==HttpStatus.OK) {
				Alumno alumnoEquisfax = (Alumno) respuesta.getBody();
				alumnoNew = alumnoService.save(alumnoEquisfax);
			}else {
	...
	public ResponseEntity<?> update(@Validated @RequestBody Alumno alumno, BindingResult result,
		...
		try {
            ...
            alumnoActual.setPhone(alumno.getPhone());
